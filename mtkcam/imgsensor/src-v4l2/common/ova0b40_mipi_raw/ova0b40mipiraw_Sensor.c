 ...
 *============================================================================
 ****************************************************************************/
#include "ova0b40mipiraw_Sensor.h"

static void set_sensor_cali(void *arg);

static void set_group_hold(void *arg, u8 en);
//static void ova0b40_set_dummy(struct subdrv_ctx *ctx);
//static int ova0b40_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static u16 get_gain2reg(u32 gain);
static int ova0b40_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static void ova0b40_sensor_init(struct subdrv_ctx *ctx);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, ova0b40_set_test_pattern},
...
static struct eeprom_info_struct eeprom_info[] = {
	{
		...
		.xtalk_support = false,
		.xtalk_table = data_xtalk_ova0b402q,
		.xtalk_size = ARRAY_SIZE(data_xtalk_ova0b402q),
...
//drv add by lipengpeng 20240815 start
	{
		...
		.mode_setting_table = addr_data_pair_preview_ova0b402q,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_preview_ova0b402q),
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_hs_video_ova0b402q,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_hs_video_ova0b402q),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
static struct subdrv_static_ctx static_ctx = {
	...
	.i2c_addr_table = {0x6c, 0xff}, //drv add by lipengpeng 20240815  , 0x20
	.i2c_burst_write_support = TRUE,
	.i2c_transfer_data_type = I2C_DT_ADDR_16_DATA_8, //drv add by lipengpeng 20240815  add16 data8
	.eeprom_info = eeprom_info,
	.eeprom_num = ARRAY_SIZE(eeprom_info),
	.resolution = {11584, 8688}, //drv add by lipengpeng 20240815 
	.mirror = IMAGE_NORMAL,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 4,
	.ana_gain_table = ova0b40_ana_gain_table,
	.ana_gain_table_size = sizeof(ova0b40_ana_gain_table),
	.min_gain_iso = 100,
	.exposure_def = 0x3D0,
	.exposure_min = 8,
...
//drv add by lipengpeng 20240531 start for PDAF
	.pdaf_type = PDAF_SUPPORT_NA,//PDAF_SUPPORT_CAMSV_QPD,// PDAF_SUPPORT_CAMSV_QPD,  PDAF_SUPPORT_NA
...
#if IS_ENABLED(CONFIG_DRV_ADC_GMS_DETECT)
    printk("ova0b40 ---- gms_detection_getadc_v()=%d\n",gms_detection_getadc_v());
  if(check_board_type()==0)
    {
	 printk(" ova0b40 is volume production\n");
   }else{
	...
	while (ctx->s_ctx.i2c_addr_table[i] != 0xFF) {
		...
		do {
			*sensor_id = (subdrv_i2c_rd_u8(ctx, addr_h) << 8) |
			...
			//*sensor_id +=1;
			printk("ova0b40 i2c_write_id(0x%x) sensor_id(0x%x/0x%x)\n",ctx->i2c_write_id, *sensor_id, ctx->s_ctx.sensor_id);
			if (*sensor_id == OVA0B40_SENSOR_ID) {
...
const struct subdrv_entry ova0b40_mipi_raw_entry = {
	.name = "ova0b40_mipi_raw",
	.id = OVA0B40_SENSOR_ID,
	.pw_seq = pw_seq,
...
//drv add by lipengpeng 20240828 end  
   //i2c_table_write(ctx, sensor_init_addr_data, sizeof(sensor_init_addr_data)/sizeof(u16));
	...
	printk("ova0b40_sensor_init end\n");
}
static int open(struct subdrv_ctx *ctx)
{
	u32 sensor_id = 0;

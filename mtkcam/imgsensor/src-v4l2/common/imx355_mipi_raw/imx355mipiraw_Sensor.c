...
static int imx355_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int imx355_set_test_pattern_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
...
static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, imx355_set_test_pattern},
	{SENSOR_FEATURE_SET_TEST_PATTERN_DATA, imx355_set_test_pattern_data},
};
...
static struct subdrv_mode_struct mode_struct[] = {
	{
		...
		.mode_setting_table = imx355_preview_setting,
		.mode_setting_len = ARRAY_SIZE(imx355_preview_setting),
	...
	},
	{
		...
		.mode_setting_table = imx355_capture_setting,
		.mode_setting_len = ARRAY_SIZE(imx355_capture_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = imx355_normal_video_setting,
		.mode_setting_len = ARRAY_SIZE(imx355_normal_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = imx355_hs_video_setting,
		.mode_setting_len = ARRAY_SIZE(imx355_hs_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = imx355_slim_video_setting,
		.mode_setting_len = ARRAY_SIZE(imx355_slim_video_setting),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
static struct subdrv_static_ctx static_ctx = {
	...
	.ana_gain_table = imx355_ana_gain_table,
	.ana_gain_table_size = sizeof(imx355_ana_gain_table),
	...
	.init_setting_table = imx355_init_setting,
	.init_setting_len = ARRAY_SIZE(imx355_init_setting),
	.mode = mode_struct,
...
/*static kal_uint32 return_lot_id_from_otp(struct subdrv_ctx *ctx)//((read_cmos_sensor(0x0016) << 8) | read_cmos_sensor(0x0017));
{
	kal_uint16 val = 0;
	int i = 0;
	...
	while (static_ctx.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			*sensor_id = (subdrv_i2c_rd_u8(ctx, addr_h) << 8) |
			...
			printk("imx355 i2c_write_id(0x%x) sensor_id(0x%x/0x%x)\n",ctx->i2c_write_id, *sensor_id, ctx->s_ctx.sensor_id);
			/* return_sensor_id(); */

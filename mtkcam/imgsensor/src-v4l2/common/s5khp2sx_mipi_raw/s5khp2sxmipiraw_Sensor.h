 ...
 *
 ****************************************************************************/
#ifndef _S5KHP2SXMIPI_SENSOR_H
#define _S5KHP2SXMIPI_SENSOR_H
...
extern bool read_HP2SX_eeprom(kal_uint16 addr, BYTE *data, kal_uint32 size);

...
struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION
	...
	{	{'G', '0'}
		, 149, {48, 32, 32, 32, 32, 32, 32, 32, 32}
	}
	,
	{	{'G', '0'}
		, 157, {48, 32, 32, 32, 32, 32, 32, 32, 32}
	}
	,
	{	{'G', '0'}
		, 165, {48, 32, 32, 32, 32, 32, 32, 32, 32}
	}
	,
	{	{'G', '0'}
		, 151, {48, 32, 32, 32, 32, 32, 32, 32, 32}
	}
	,
	{	{'G', '0'}
		, 159, {48, 32, 32, 32, 32, 32, 32, 32, 32}
	}
	,
	{	{'A', 'I'}
...
static struct COUNTRY_POWER_LIMIT_COUNTRY_CODE g_u2CountryLimitGrp0[] = {{'E','S'},{'I','T'},{'F','R'},{'N','L'},{'P','L'},{'B','E'},{'B','G'},{'R','O'},{'D','E'},{'D','K'},{'C','Z'},{'S','K'},{'H','U'},{'G','R'},{'H','R'},{'A','T'},{'S','I'},{'L','U'},{'L','V'},{'L','T'},{'P','T'},{'S','E'},{'F','I'},{'C','Y'},{'M','T'},{'N','Z'},{'S','A'},{'T','H'},{'P','H'},{'L','K'},{'S','G'},{'A','E'},{'K','E'},{'K','Z'},{'M','M'},{'B','D'},{'P','K'},{'I','R'},{'H','K'},{'G','B'},{'T','R'},{'K','H'},{'C','H'},{'U','A'},{'B','R'},{'C','L'},{'M','X'},{'P','E'},{'Z','A'},{'Q','A'},{'K','W'}};
